...
//   @override
//   void initState() {
//     final userData = {"key": '', "subscribed": true};
...
//       setState(() {
//         r1 = event.docs.last.data()['r1'] != 0;
//         r2 = event.docs.last.data()['r2'] != 0;
//         r3 = event.docs.last.data()['r3'] != 0;
//         r4 = event.docs.last.data()['r4'] != 0;
//         r5 = event.docs.last.data()['r5'] != 0;
//       });
//       print(event.docs.last.data());
//     });
...
//                           values: humidity_1,
//                           interval: 20,
//                           color: Color.fromARGB(255, 170, 23, 104)),
//                     ],
//                   ),
//                 ),
//                 const SizedBox(
...
//                             interval: 2,
//                             color: const Color.fromARGB(255, 170, 23, 104)),
//                       ],
//                     ))
//               ],
//             ),
