...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Map<String, dynamic> settings = {'ip': '', 'language': 'en', 'font_scale': 1};
                        ...
                        if (_ipValid) {
                          ...
                          showDialog<String>(
                            ...
                            builder: (BuildContext context) =>
                              ...
                              content: Text('Inputs are invalid'),
                            ),
                          );
                        }
                      },
  ...
  int countNotifications(Map<String, dynamic> notifications) {
    int notificationsFromServer = 0;
    notifications.forEach((key, value) {
      notificationsFromServer = notificationsFromServer + (value.length as int);
    });
